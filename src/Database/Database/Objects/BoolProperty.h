 ...
 */
#ifndef DATABASE_BOOLPROPERTY_H_
#define DATABASE_BOOLPROPERTY_H_
 ...
 * @class BoolProperty
 *
 * @brief The very most simple Property, a single true or false value.
 */
class BoolProperty : public Property {
 public:
  ...
  static constexpr const char* propertytype = "bool_property";
   ...
   */
  static BoolProperty create(const std::string& name, const Model& model, bool data, const CollectionPtr& collection);
   ...
   * @returns An instance of the new property
   */
  static BoolProperty create(const std::string& name, const Model& model, bool data, const ID& structure,
   ...
   */
  ID create(const Model& model, const std::string& propertyName, bool data);
  /**
   * @brief Creates a new document in the linked collection.
   * @throws MissingLinkedCollectionException Thrown if no collection is linked.
   * @param model        The model used to calculate the property.
   ...
   * @return ID          The id of the inserted document.
   */
  ID create(const Model& model, const std::string& propertyName, const ID& structure, const ID& calculation, bool data);

  /**
   * @brief Get the data.
   * @throws MissingLinkedCollectionException Thrown if no collection is linked.
   * @throws MissingIDException Thrown if the object does not have an ID.
   * @return bool The data.
   */
  bool getData() const;
  /**
   * @brief Set the data.
