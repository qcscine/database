 ...
 */
#ifndef DATABASE_STRINGPROPERTY_H_
#define DATABASE_STRINGPROPERTY_H_
 ...
 * @brief A property class for data stored in a string.
 */
class StringProperty : public Property {
 public:
  ...
  static constexpr const char* propertytype = "string_property";
   ...
   */
  static StringProperty create(const std::string& name, const Model& model, const std::string& data,
   ...
   */
  ID create(const Model& model, const std::string& propertyName, const std::string& data);
  /**
   * @brief Creates a new document in the linked collection.
   * @throws MissingLinkedCollectionException Thrown if no collection is linked.
   * @param model        The model used to calculate the property.
